  ...
  return (
    <footer className="bg-[#0a0a0a] text-gray-400">
      <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-2 md:grid-cols-5 gap-10">
        <div className="col-span-2 md:col-span-1">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-white font-bold text-base tracking-wide">YUNX DETEKTION</span>
          </div>
        ...
        <div>
          <h4 className="text-white font-semibold text-sm mb-4 tracking-wide">Learn More</h4>
          <ul className="space-y-2.5 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>service@yunx-tek.com</span>
            </li>
            <li className="flex items-start gap-2">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="mt-0.5 flex-shrink-0">
              ...
              <span className="leading-relaxed">3F., No. 329-1, Longjiang Rd.,<br/>Zhongshan Dist., Taipei City</span>
            </li>
          </ul>
      ...
      <div className="max-w-7xl mx-auto px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-gray-600">
        <span>© 2026 YUNX Detektion. All rights reserved.</span>
